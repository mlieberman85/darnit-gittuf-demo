...
Thanks for using darnit-gittuf-demo! Here are some ways to get help:
...
1. Search [existing issues](https://github.com/mlieberman85/darnit-gittuf-demo/issues) first
2. If not found, [open a new issue](https://github.com/mlieberman85/darnit-gittuf-demo/issues/new)
...
Want to help improve darnit-gittuf-demo? See our [Contributing Guide](CONTRIBUTING.md).
